...
const Customer = () => {
    return <>
        <div className="bg-gray-600 mx-8">
            <div className="mt-10">
            ...
            <div className="">
                <div className="grid grid-cols-12">
                    <div className="lg:col-span-6 col-span-12 bg-gray-800 py-8 rounded-lg mx-8 mb-10">
                    ...
                    <div className="lg:col-span-6 col-span-12 lg:mt-0 mt-5 bg-gray-800 py-8 rounded-lg mx-8 mb-10">
                        <div className="text-white flex gap-3 mx-10">
                            <i className='bi bi-star-fill text-yellow-400'></i>
                            <i className='bi bi-star-fill text-yellow-400'></i>
                            <i className='bi bi-star-fill text-yellow-400'></i>
                        ...
                        <div className="text-white mx-10 mt-5">
                            <p className='text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis, dolor inventore repellendus soluta ullam provident deserunt laboriosam quae sit praesentium!</p>
                        </div>
                        <div className="">
                            <div className="mx-10 mt-5 flex text-white gap-5">
