        ...
        <div className=" bg-slate-900 ">
            <div className="md:flex lg:flex p-5 justify-between ">
                <div className="flex gap-5 mx-8 text-center text-gray-500 mt-2">
                    <i class="bi bi-envelope font-bold text-1xl text-yellow-500"></i><p>info@example.com</p>
                    <i className='bi bi-telephone text-yellow-500 text-1xl font-bold '></i><p>+880 1688 33300</p>
                </div>
