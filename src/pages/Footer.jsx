                        ...
                        <div className="lg:col-span-3 col-span-12">
                            <div className="lg:py-20 px-10">
                                ...
                                <div className="border-none">
                                    <input type="text" className='px-1 py-3 rounded mt-3 text-center' placeholder='Emali Address' /> <button className='py-3 px-1 rounded bg-yellow-400 text-white'>Subscribe</button>
                                </div>
                            </div>
                        </div>
                    </div>
