                ...
                <div className="col-span-12 lg:col-span-4 lg:py-20">
                    <div className="mt-14 text-white flex ">
                        ...
                        <div className="ms-auto">
                            <button className='bg-yellow-400 py-5 mt-3 lg:px-8 px-7  text-white rounded-lg '>Current</button>
                        </div>
                    </div>
                    ...
                    <div className="mt-14 text-white flex gap-10">
                        ...
                        <div className="ms-auto">
                        <button className='bg-yellow-400 py-5 mt-3 lg:px-8 px-7  text-white rounded-lg '>2018-2020</button>
                        </div>
                    </div>
                    <div className="border"></div>
                    <div className="mt-14 text-white flex gap-10">
